...
{
    public class InsertDescargaCommandHandler : IRequestHandler<InsertDescargaCommand, CommandResponse>
    {
        private readonly IBaseRepository<Model.Contenido> _contenidoRepository;

        public InsertDescargaCommandHandler(IBaseRepository<Model.Contenido> contenidoRepository)
        {
